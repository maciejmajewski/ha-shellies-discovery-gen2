...
DEVICE_TRIGGER_MAP = {
    ...
    EVENT_BTN_UP: TRIGGER_BUTTON_UP,
    EVENT_BTN_DOWN: TRIGGER_BUTTON_DOWN,
}
...
SUPPORTED_MODELS = {
    ...
    MODEL_PRO_4PM: {
        ...
        ATTR_INPUTS: 4,
        ATTR_INPUT_BINARY_SENSORS: {SENSOR_INPUT: DESCRIPTION_SENSOR_INPUT},
        ATTR_INPUT_EVENTS: [EVENT_SINGLE_PUSH, EVENT_DOUBLE_PUSH, EVENT_LONG_PUSH, EVENT_BTN_UP, EVENT_BTN_DOWN],
        ATTR_RELAYS: 4,
        ATTR_RELAY_BINARY_SENSORS: {
            SENSOR_OVERPOWER: DESCRIPTION_SENSOR_OVERPOWER,
            SENSOR_OVERTEMP: DESCRIPTION_SENSOR_OVERTEMP,
